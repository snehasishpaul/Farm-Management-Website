...
<body>
        ...
        <nav>
                <div class="nav-wrapper">
                    <a href="home.php" class="brand-logo center">Products Data</a>
                </div>
        ...
        <aside class="aside-left">
            <?php
                ...
                if ($result->num_rows > 0) {
                    echo "<table><tr><th>Product ID</th><th>Product Name</th><th>Product Category</th><th>Product Price</th></tr>";
                    while($row = $result->fetch_assoc()) {
                        $a = $row["p_id"];
                        echo "<tr><td>".$row["p_id"]."</td><td>".$row["p_name"]."</td><td>".$row["p_category"]."</td><td>".$row["p_price"]."</td></tr>";
                    }
                    echo "</table>";
                }else{
                    echo "No Data";
