...
<body>
        ...
        <nav>
                <div class="nav-wrapper">
                    <a href="home.php" class="brand-logo center">Transaction Data</a>
                </div>
        ...
        <aside class="aside-left">
            <?php
                ...
                if ($result->num_rows > 0) {
                    echo "<table><tr><th>Transaction ID</th><th>Buyer Name</th><th>Product Name</th><th>Product Quantity</th><th>Product Price</th><th>Card Number</th><th>Purchase Date</th></tr>";
                    while($row = $result->fetch_assoc()) {
                        $a = $row["transaction_id"];
                        echo "<tr><td>".$row["transaction_id"]."</td><td>".$row["b_name"]."</td><td>".$row["p_name"]."</td><td>".$row["p_quantity"]."</td><td>".$row["p_price"]."</td><td>".$row["card_number"]."</td><td>".$row["p_date"]."</td></tr>";
                    }
                    echo "</table>";
                }else{
                    echo "No Data";
